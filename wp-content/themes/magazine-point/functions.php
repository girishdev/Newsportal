...
function magazine_point_scripts() {
	...
	wp_enqueue_style( 'magazine-point-style', get_stylesheet_uri(), array(), '1.0.5' );
	...
	wp_enqueue_script( 'my-own-script', get_template_directory_uri() . '/js/myownscript.js', array( 'jquery' ), '2.1.6', true );
